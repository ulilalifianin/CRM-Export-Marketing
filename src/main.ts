...
const translations: Record<UiLanguage, Record<string, string>> = {
  id: {
    ...
    heroTitle: 'Dashboard ini difokuskan untuk scan cepat, update cepat, dan kontrol customer yang lebih kuat dari Excel.',
    heroCopy:
    ...
    quickUxIdea: 'Tips penggunaan cepat',
    quickUxIdeaDesc: 'Hal kecil yang bikin kerja harian terasa lebih ringan',
  ...
  en: {
    ...
    heroTitle: 'This dashboard focuses on faster scanning, faster updates, and stronger customer control than Excel.',
    heroCopy:
    ...
    quickUxIdea: 'Quick usage tips',
    quickUxIdeaDesc: 'Small things that make daily work feel lighter',
